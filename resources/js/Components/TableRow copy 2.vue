...
<template>
    <tr v-if="gender === 'Feminino'" class="bg-pink-100 hover:bg-pink-100 hover:text-pink-900">
        ...
        <td>
            ...
            <!-- <i class="fa-solid fa-trash text-red-600 mx-2" style="cursor:pointer;" v-on:click="deleteSuggestion(action)" title="Remover Sugestão"></i> -->
        </td>
    ...
    <tr v-else-if="gender === 'Masculino'" class="bg-blue-100 hover:bg-blue-100 hover:text-blue-900">
        ...
        <!-- <td v-if="findLike(action)"><i class="fa-regular fa-thumbs-up text-green-600" style="cursor:pointer;" v-on:click="descurtir(action)" title="Remover Like"></i></td>
        <td v-else><i class="fa-regular fa-thumbs-up text-gray-600" style="cursor:pointer;" v-on:click="curtir(action)" title="Adicionar Like" ></i></td> -->
    </tr>
